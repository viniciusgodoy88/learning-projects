...
This repository contains Python learning projects and practical exercises
developed to strengthen programming logic, problem-solving skills, and core development fundamentals.

The focus is on algorithmic thinking, user input handling, and structured code organization.
...
Each project is organized as an individual script inside the repository:
